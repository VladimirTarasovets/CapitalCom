...
public class OldMainPage {
    ...
    private static final SelenideElement SCROLL_ELM_TRADE_NOW_BTN  = $(byCssSelector("#tools"));
    private static final SelenideElement TRADE_NOW_BTN = $(byXpath("//a[@class='button-main js_signup hidden-small'][@data-type='hp_choose_capital']"));
